...
class BeastViewController: UIViewController {
    ...
    var timeLeft = 20 // Start with 20 seconds for Beast mode
    var timer: Timer!
    ...
    func setupGame() {
        ...
        timeLeft = 20 // Set to 20 seconds for Beast mode
...
// Remove the UITextFieldDelegate conformance and related methods if not needed
extension BeastViewController: UITextFieldDelegate {
