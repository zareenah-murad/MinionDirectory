...
class TableViewController: UITableViewController {
    ...
    var minions: [Minion] = [
        Minion(name: "Bob", imageName: "Bob", description: "Bob is a young and cheerful Minion, and is 6 years old (in Minion years). He's known for his childlike innocence, always carrying his beloved teddy bear, Tim. Bob is incredibly loyal and loves making new friends. On a scale of 1-10, his love for bananas ranks at a solid 5, making him a devoted fan, though not as obsessed as some of his fellow Minions!"),
        Minion(name: "Carl", imageName: "Carl", description: "Carl is a fun-loving and quirky Minion, standing out with his single eye and love for practical jokes. At 7 years old (in Minion years), he's always looking for new ways to make his fellow Minions laugh. Carl has a mischievous streak, but his heart is always in the right place. On a scale of 1-10, Carl’s love for bananas is an 8, making him a true banana enthusiast!"),
        Minion(name: "Dave", imageName: "Dave", description: "Dave, at 8 years old (in Minion years), is known for being one of the more adventurous and tech-savvy Minions. He loves video games and gadgets, often showing off his skills to his Minion friends. His love for bananas is a respectable 6 on a scale of 1-10, meaning he enjoys them but isn’t as fanatical as some of the others."),
        Minion(name: "Kevin", imageName: "Kevin", description: "Kevin is one of the oldest and wisest of the Minions at 9 years old (in Minion years). He takes his role as a leader seriously, often looking out for his younger Minion friends. Known for his tall stature and practical approach to problems, Kevin has a calm and collected presence. On a scale of 1-10, his love for bananas is a 9, making him one of the biggest banana fans around, always ready for a banana-fueled adventure."),
        Minion(name: "Stuart", imageName: "Stuart", description: "Stuart is the laid-back, cool Minion with a talent for music, especially the guitar. At 7 years old (in Minion years), Stuart prefers to chill and jam to his favorite tunes rather than get caught up in the chaos. His love for bananas is a steady 7 on a scale of 1-10, balancing his affection for the fruit with his other laid-back passions."),
    ]
